...
export const MATERIALS: Record<MaterialKind, MaterialParams> = {
  champagneMetal: { color: '#b8ac8d', metalness: 0.9, roughness: 0.4, envMapIntensity: 1.1 },
  darkBoard: { color: '#16171a', metalness: 0.25, roughness: 0.55, clearcoat: 0.4, clearcoatRoughness: 0.35 },
  copper: { color: '#a87652', metalness: 1, roughness: 0.32, envMapIntensity: 1.3 },
  gold: { color: '#b79c61', metalness: 1, roughness: 0.3, envMapIntensity: 1.2 },
  ...
  substrate: { color: '#263d36', metalness: 0.2, roughness: 0.5 },
